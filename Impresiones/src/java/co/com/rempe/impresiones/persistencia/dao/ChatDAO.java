...
public class ChatDAO extends GenericoDAO<Chat> {
    ...
    public Chat consultarUltimoChatUOrigen(int idUsuario, long idConversacion) {
        Query q = null;
    ...
    public Chat consultarUltimoChatUDestino(int idUsuario, long idConversacion) {
        Query q = null;
        System.out.println("Id usuairo recibido: " + idUsuario);
        try {
    ...
    public List<Chat> chatsConversacion(int idUsuarioOrigen, int idUsuarioDestino, long idConversacion) {
        Query q = null;
        try {
