...
public class Clip implements Serializable {
    ...
    public Clip(Integer idClip, BigDecimal clip, BigDecimal recuperacionInversion) {
        this.idClip = idClip;
        this.clip = clip;
    ...
    public String toString() {
        return "co.com.progredi.impresiones.persistencia.entidades.Clip[ idClip=" + idClip + " ]";
    }
