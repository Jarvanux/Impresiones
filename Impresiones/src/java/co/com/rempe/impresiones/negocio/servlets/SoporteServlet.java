...
import co.com.rempe.impresiones.negocio.delegado.SoporteDelegado;
 ...
 */
@WebServlet(name = "SoporteServlet", urlPatterns = {"/soporteconectado"})
public class SoporteServlet extends HttpServlet {

    private SoporteDelegado soporteDelegado;
    
    public void init() throws ServletException{
        super.init();
        soporteDelegado = SoporteDelegado.getInstancia();
    }
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            switch(direccion){
                case SOPORTE_CONECTADO:
                    respuesta = soporteConectado();
                    break;
            }
        } catch (Exception e) {
    ...
    private Respuesta soporteConectado() throws IOException{
    return soporteDelegado.soporteDisponible();
    }
